    ...
    <div className="space-y-6">
      ...
      >
        ...
        <Button 
          ...
          className="bg-accent hover:bg-accent-hover text-white px-6 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 active:scale-95"
        >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid w-full grid-cols-4 bg-white rounded-xl shadow-md p-1">
          <TabsTrigger value="manage" className="rounded-xl data-[state=active]:bg-accent data-[state=active]:text-white">
            <ClipboardList className="w-4 h-4 mr-2" />
            Manage
          </TabsTrigger>
          <TabsTrigger value="results" className="rounded-xl data-[state=active]:bg-accent data-[state=active]:text-white">
            <Award className="w-4 h-4 mr-2" />
            Results
          </TabsTrigger>
          <TabsTrigger value="analytics" className="rounded-xl data-[state=active]:bg-accent data-[state=active]:text-white">
            <BarChart3 className="w-4 h-4 mr-2" />
            Analytics
          </TabsTrigger>
          <TabsTrigger value="proctoring" className="rounded-xl data-[state=active]:bg-accent data-[state=active]:text-white">
