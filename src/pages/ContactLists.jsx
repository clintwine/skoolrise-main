...
export default function ContactLists() {
  ...
  const { data: lists = [] } = useQuery({
    ...
    queryFn: () => base44.entities.ContactList.filter(addSchoolFilter({}, school_tenant_id), '-created_date'),
    enabled: isReady,
  });
  ...
  const createMutation = useMutation({
    mutationFn: (data) => base44.entities.ContactList.create(withSchoolId(data, school_tenant_id)),
    onSuccess: () => {
