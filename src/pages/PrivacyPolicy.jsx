        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              SkoolRise ("we," "our," or "us") is committed to protecting the privacy of our users. 
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Student information (academic records, attendance, grades)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Process payments and manage school fees</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Our service is designed for use by schools and includes information about minors. 
              We comply with applicable data protection laws regarding children's information and 
              require parental consent where necessary.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mt-4">
              Email: privacy@skoolrise.com<br />
